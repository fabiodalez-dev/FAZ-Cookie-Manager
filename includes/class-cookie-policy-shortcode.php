...
' );
		...
		<p><button type="button" class="faz-policy-manage-btn" onclick="if(typeof fazcookie!=='undefined'){fazcookie.showBanner();}"><?php esc_html_e( 'Manage Cookie Preferences', 'faz-cookie-manager' ); ?></button></p>
