...
class Admin {
	...
	public function woocommerce_compat_notice() {
		...
		echo esc_html__( 'FAZ Cookie Manager automatically whitelists WooCommerce core scripts on checkout and cart pages, and payment gateway SDKs (PayPal, Stripe, Square, Braintree, Klarna) site-wide, so your store keeps working. This can be customised via the', 'faz-cookie-manager' );
