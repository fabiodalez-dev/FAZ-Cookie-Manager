		...
		wp_localize_script(
			...
			array(
				...
				'i18n'           => array(
					...
					'accepted'                 => esc_html__( 'Accepted', 'faz-cookie-manager' ),
					'rejected'                 => esc_html__( 'Rejected', 'faz-cookie-manager' ),
					'totalResponses'           => esc_html__( 'total responses', 'faz-cookie-manager' ),
					// Common.
					'saved'                    => esc_html__( 'Settings saved successfully.', 'faz-cookie-manager' ),
					'saveFailed'               => esc_html__( 'Failed to save settings.', 'faz-cookie-manager' ),
					'loadFailed'               => esc_html__( 'Failed to load settings.', 'faz-cookie-manager' ),
					'confirmDelete'            => esc_html__( 'Are you sure you want to delete this?', 'faz-cookie-manager' ),
					// Cookies page.
					'cookies'                  => array(
						'bulkDeleteConfirm'        => esc_html__( 'Delete selected cookie(s)?', 'faz-cookie-manager' ),
						'bulkDeleteFailed'         => esc_html__( 'Bulk delete failed.', 'faz-cookie-manager' ),
						'categoriesSaved'          => esc_html__( 'Categories saved.', 'faz-cookie-manager' ),
						...
						'deleteStale'              => esc_html__( 'Delete stale', 'faz-cookie-manager' ),
						'category'                 => esc_html__( 'Category', 'faz-cookie-manager' ),
						'cancel'                   => esc_html__( 'Cancel', 'faz-cookie-manager' ),
						'cookieUpdated'            => esc_html__( 'Cookie updated.', 'faz-cookie-manager' ),
						'cookieAdded'              => esc_html__( 'Cookie added.', 'faz-cookie-manager' ),
						'cookieSaveFailed'         => esc_html__( 'Failed to save cookie.', 'faz-cookie-manager' ),
						'cookieDeleteConfirm'      => esc_html__( 'Delete cookie "%s"?', 'faz-cookie-manager' ),
						'cookieDeleted'            => esc_html__( 'Cookie deleted.', 'faz-cookie-manager' ),
						'cookieDeleteFailed'       => esc_html__( 'Failed to delete cookie.', 'faz-cookie-manager' ),
						'staleDeleted'             => esc_html__( 'Stale cookie deleted.', 'faz-cookie-manager' ),
						'staleDeleteFailed'        => esc_html__( 'Failed to delete stale cookie.', 'faz-cookie-manager' ),
						'staleAllConfirm'          => esc_html__( 'Delete all stale cookies not found in the latest scan?', 'faz-cookie-manager' ),
						'staleNone'                => esc_html__( 'No stale cookies to delete.', 'faz-cookie-manager' ),
						'staleDeleteAllFailed'     => esc_html__( 'Failed to delete stale cookies.', 'faz-cookie-manager' ),
						'staleLoadFailed'          => esc_html__( 'Failed to load cookies for stale cleanup.', 'faz-cookie-manager' ),
						'scanStarted'              => esc_html__( 'Scanning...', 'faz-cookie-manager' ),
						'scanSite'                 => esc_html__( 'Scan Site', 'faz-cookie-manager' ),
						'discoveringPages'         => esc_html__( 'Discovering pages...', 'faz-cookie-manager' ),
						'enrichingServer'          => esc_html__( 'Enriching with server scan...', 'faz-cookie-manager' ),
						'savingResults'            => esc_html__( 'Saving results...', 'faz-cookie-manager' ),
						'noCookiesToProcess'       => esc_html__( 'No cookies to process.', 'faz-cookie-manager' ),
						'noUncategorized'          => esc_html__( 'No uncategorized cookies to process.', 'faz-cookie-manager' ),
						'noneAutoCategorized'      => esc_html__( 'No cookies could be auto-categorized.', 'faz-cookie-manager' ),
						'autoCatFailed'            => esc_html__( 'Auto-categorize failed.', 'faz-cookie-manager' ),
						'noDefinitions'            => esc_html__( 'No definitions downloaded yet. Click "Update Definitions" to download.', 'faz-cookie-manager' ),
						'definitionsLoadFailed'    => esc_html__( 'Could not load definitions status.', 'faz-cookie-manager' ),
						'downloadingDefinitions'   => esc_html__( 'Downloading definitions from GitHub...', 'faz-cookie-manager' ),
						'definitionsUpdated'       => esc_html__( 'Definitions updated.', 'faz-cookie-manager' ),
						'definitionsFailed'        => esc_html__( 'Update failed.', 'faz-cookie-manager' ),
						'definitionsNetworkFailed' => esc_html__( 'Update failed. Check your network connection.', 'faz-cookie-manager' ),
						'select'                   => esc_html__( '— Select —', 'faz-cookie-manager' ),
						'remove'                   => esc_html__( 'Remove', 'faz-cookie-manager' ),
						'rulesIncomplete'          => esc_html__( 'rule(s) incomplete — fill in both pattern and category.', 'faz-cookie-manager' ),
						'rulesSaved'               => esc_html__( 'Custom rules saved.', 'faz-cookie-manager' ),
						'rulesSaveFailed'          => esc_html__( 'Failed to save custom rules.', 'faz-cookie-manager' ),
						'noTemplates'              => esc_html__( 'No templates available.', 'faz-cookie-manager' ),
						'templateEmpty'            => esc_html__( 'No patterns or cookies in template.', 'faz-cookie-manager' ),
						'templateCatNotFound'      => esc_html__( 'not found — cookies not added.', 'faz-cookie-manager' ),
						'templateCookiesFailed'    => esc_html__( 'Failed to create cookies from template.', 'faz-cookie-manager' ),
						'templateLoadFailed'       => esc_html__( 'Failed to load templates.', 'faz-cookie-manager' ),
					),
					// Banner page.
					'banner'                   => array(
					...
					'settings'                 => array(
						...
						'saved'                    => esc_html__( 'Settings saved successfully.', 'faz-cookie-manager' ),
						'saveFailed'               => esc_html__( 'Failed to save settings.', 'faz-cookie-manager' ),
						'gvlUpdated'               => esc_html__( 'GVL updated.', 'faz-cookie-manager' ),
						'gvlFailed'                => esc_html__( 'Failed to update GVL.', 'faz-cookie-manager' ),
						'geoipNoKey'               => esc_html__( 'Please enter a MaxMind license key first.', 'faz-cookie-manager' ),
						'geoipUpdated'             => esc_html__( 'GeoIP database updated successfully.', 'faz-cookie-manager' ),
						'geoipFailed'              => esc_html__( 'Failed to update database.', 'faz-cookie-manager' ),
						'noGvlData'                => esc_html__( 'No GVL data downloaded yet. Click "Update GVL Now" to download.', 'faz-cookie-manager' ),
						'noGvlAvailable'           => esc_html__( 'No GVL data available.', 'faz-cookie-manager' ),
						'gvlVersion'               => esc_html__( 'GVL Version: ', 'faz-cookie-manager' ),
						'gvlVendors'               => esc_html__( 'Vendors: ', 'faz-cookie-manager' ),
						'gvlLastUpdated'           => esc_html__( 'Last Updated: ', 'faz-cookie-manager' ),
						'dbLabel'                  => esc_html__( 'Database: ', 'faz-cookie-manager' ),
						'noGeoipDb'                => esc_html__( 'No GeoIP database installed. Enter your license key and click "Update Database".', 'faz-cookie-manager' ),
					),
					// GCM page.
					'gcm'                      => array(
						'loadFailed'               => esc_html__( 'Failed to load GCM settings.', 'faz-cookie-manager' ),
						'saved'                    => esc_html__( 'GCM settings saved successfully.', 'faz-cookie-manager' ),
						'saveFailed'               => esc_html__( 'Failed to save GCM settings.', 'faz-cookie-manager' ),
					),
					// Consent logs page.
					'consentLogs'              => array(
						...
						'exportFailed'             => esc_html__( 'Failed to export CSV.', 'faz-cookie-manager' ),
						'prev'                     => esc_html__( '← Prev', 'faz-cookie-manager' ),
						'next'                     => esc_html__( 'Next →', 'faz-cookie-manager' ),
					),
					// Languages page.
					'languages'                => array(
						'loadFailed'               => esc_html__( 'Failed to load languages.', 'faz-cookie-manager' ),
						'noLanguages'              => esc_html__( 'No languages selected. Add one below.', 'faz-cookie-manager' ),
					...
					// GVL page.
					'gvl'                      => array(
						'noData'                   => esc_html__( 'No GVL data downloaded yet. Click "Update GVL Now" to download.', 'faz-cookie-manager' ),
						'loadFailed'               => esc_html__( 'Failed to load GVL status.', 'faz-cookie-manager' ),
						...
						'updateFailed'             => esc_html__( 'Failed to update GVL.', 'faz-cookie-manager' ),
						'version'                  => esc_html__( 'GVL Version: ', 'faz-cookie-manager' ),
						'vendors'                  => esc_html__( 'Vendors: ', 'faz-cookie-manager' ),
						'lastUpdated'              => esc_html__( 'Last Updated: ', 'faz-cookie-manager' ),
					),
					// Import/Export page.
					'importExport'             => array(
						'exporting'                => esc_html__( 'Exporting...', 'faz-cookie-manager' ),
						'exportOk'                 => esc_html__( 'Settings exported successfully.', 'faz-cookie-manager' ),
						'exportFailed'             => esc_html__( 'Export failed.', 'faz-cookie-manager' ),
						'invalidJson'              => esc_html__( 'Invalid JSON file.', 'faz-cookie-manager' ),
						'notFazExport'             => esc_html__( 'This file is not a FAZ Cookie Manager export.', 'faz-cookie-manager' ),
						'importConfirm'            => esc_html__( 'This will overwrite your current settings. Continue?', 'faz-cookie-manager' ),
					...
					// Dashboard page.
					'dashboard'                => array(
						'selectBothDates'          => esc_html__( 'Please select both start and end dates.', 'faz-cookie-manager' ),
						'startBeforeEnd'           => esc_html__( 'Start date must be before end date.', 'faz-cookie-manager' ),
						'noCategoryData'           => esc_html__( 'No category data yet.', 'faz-cookie-manager' ),
					),
				),
			)
		);
