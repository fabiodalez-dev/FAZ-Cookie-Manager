...
Die verantwortliche Stelle (responsible party) für die Verarbeitung Ihrer personenbezogenen Informationen über Cookies ist:

- **Verantwortliche Stelle:** {{COMPANY_NAME}}
- **Adresse:** {{COMPANY_ADDRESS}}
- **E-Mail:** {{COMPANY_EMAIL}}
- **Register / Registrierungsnummer:** {{COMPANY_REGISTRY}}
...
Bei **unbedingt erforderlichen** Cookies ist die Verarbeitung durch unser berechtigtes Interesse am Betrieb einer sicheren, funktionsfähigen Website gerechtfertigt (POPIA, Abschnitt 11(1)(f)) und überwiegt Ihre Interessen oder Rechte nicht.
...
Nach Abschnitt 69 POPIA erfordert elektronisches Direktmarketing an Nichtkunden Ihre vorherige Einwilligung, und jede Marketingkommunikation, die Sie erhalten, muss eine Abmeldemöglichkeit enthalten.
...
Nach dem POPIA (Kapitel 3, Bedingung 8, sowie Abschnitte 23-25) haben Sie das Recht:

- über die Erhebung Ihrer personenbezogenen Informationen benachrichtigt zu werden (Abschnitt 18)
- auf Zugang zu den über Sie gespeicherten personenbezogenen Informationen (Abschnitt 23)
- auf Berichtigung oder Löschung unrichtiger, irrelevanter, übermäßiger oder unrechtmäßig erlangter Informationen (Abschnitt 24)
...
Bei Fragen zu dieser Cookie-Richtlinie kontaktieren Sie uns unter **{{COMPANY_EMAIL}}**.
