		...
		<div class="faz-card-body">
			...
			<div class="faz-form-group">
				...
				<div class="faz-lang-search-wrap">
					<input type="text" class="faz-input" id="faz-lang-search" placeholder="<?php esc_attr_e( 'Search languages...', 'faz-cookie-manager' ); ?>" autocomplete="off">
					<div id="faz-lang-dropdown" class="faz-lang-dropdown"></div>
				</div>
				<div class="faz-help"><?php
					/* translators: %d: number of available languages */
					printf( esc_html__( 'Type to search from %d available languages.', 'faz-cookie-manager' ), count( $lang_map ) );
				?></div>
			</div>
