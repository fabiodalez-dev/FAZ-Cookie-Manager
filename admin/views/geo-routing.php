...
?><div class="wrap faz-admin-page faz-geo-routing-page" id="faz-geo-routing-app"
	...
	<section class="faz-geo-panel hidden" id="faz-geo-panel-coverage" role="tabpanel" aria-labelledby="faz-geo-tab-coverage">
		...
		<p>
			<?php esc_html_e( 'Each country (and US state with privacy law) maps to a reference rule-set. Runtime application to the live banner is disabled; use this catalogue to configure and review your country-specific banners.', 'faz-cookie-manager' ); ?>
		</p>
	...
	<section class="faz-geo-panel hidden" id="faz-geo-panel-overrides" role="tabpanel" aria-labelledby="faz-geo-tab-overrides">
		...
		<p>
			<?php esc_html_e( 'Override the reference rule-set for a specific country. These overrides affect the preview only while live rule-set application is disabled. Use the dot-notation delta to selectively change individual fields (e.g. signals.cmv2.ad_storage).', 'faz-cookie-manager' ); ?>
		</p>
	...
	<section class="faz-geo-panel hidden" id="faz-geo-panel-preview" role="tabpanel" aria-labelledby="faz-geo-tab-preview">
		...
		<p>
			<?php esc_html_e( 'Simulate a visitor from any country / US state / VPN status and inspect the reference rule-set. This preview does not change live banner behaviour.', 'faz-cookie-manager' ); ?>
		</p>
