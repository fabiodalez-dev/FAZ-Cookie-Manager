...
<div id="faz-banner">
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				...
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Box: compact notice in a corner. Full-width: spans the full width of the viewport. Classic: full-width with inline category toggles and pushdown preference center.', 'faz-cookie-manager' ); ?></div>
				</div>
				...
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Sets the default colour scheme. You can further customise individual colours in the Colours tab.', 'faz-cookie-manager' ); ?></div>
				</div>
				...
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'How the detailed category preferences are displayed. Popup: modal overlay. Pushdown: expands below the banner. Sidebar: slides in from the side.', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help">
						<strong><?php esc_html_e( 'GDPR', 'faz-cookie-manager' ); ?></strong>: <?php esc_html_e( 'Shows consent category toggles. Visitors must opt-in before cookies are set.', 'faz-cookie-manager' ); ?><br>
						<strong><?php esc_html_e( 'CCPA / US State Laws', 'faz-cookie-manager' ); ?></strong>: <?php esc_html_e( 'Shows a "Do Not Sell or Share My Personal Data" opt-out link.', 'faz-cookie-manager' ); ?><br>
						<strong><?php esc_html_e( 'Both', 'faz-cookie-manager' ); ?></strong>: <?php esc_html_e( 'Shows both category toggles and opt-out link. Best for sites with visitors worldwide.', 'faz-cookie-manager' ); ?>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'After this many days, visitors will see the banner again. The Italian Garante Privacy recommends a maximum of 180 days (6 months).', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				...
				<div class="faz-form-group" id="faz-b-brandlogo-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Select or upload a logo. Uses the media library on WordPress, or file upload on ClassicPress. Recommended maximum size: 120 x 60 px.', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="tab-content" class="faz-tab-panel">
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-help" style="margin:0 0 12px;"><?php esc_html_e( 'Customise the text on each banner button. These labels are language-specific — switch language above to translate for each language.', 'faz-cookie-manager' ); ?></div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Used as aria-label for screen readers. The close button displays only the X icon — this text is read aloud by assistive technology to describe the button\'s action.', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="tab-buttons" class="faz-tab-panel">
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-help" style="margin:0 0 12px;"><?php esc_html_e( 'Control which buttons appear on the consent banner. GDPR requires that Reject and Accept have equal visual prominence.', 'faz-cookie-manager' ); ?></div>
				<div class="faz-form-group">
				...
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Opens the preference center where visitors can accept or reject individual cookie categories.', 'faz-cookie-manager' ); ?></div>
				</div>
				<div class="faz-form-group">
				...
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Shows an X icon to dismiss the banner. Note: under GDPR, closing without choosing is not valid consent — cookies remain blocked.', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Displays a detailed table of all cookies in each category inside the preference center. Recommended for GDPR transparency.', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Displays a small floating button that lets visitors reopen the preference center and change their consent choices at any time. Required by GDPR for the right to withdraw consent.', 'faz-cookie-manager' ); ?></div>
				</div>
				<div class="faz-form-group">
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'Forces a full page reload after consent is given. Useful if your theme or plugins need a fresh page load to initialise scripts that were blocked before consent.', 'faz-cookie-manager' ); ?></div>
				</div>
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'When the visitor\'s browser sends a GPC signal (Sec-GPC: 1), automatically treat it as an opt-out. Required by some US state privacy laws (e.g. California CPRA, Colorado).', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					...
					<div class="faz-help"><?php esc_html_e( 'CSS applied only to the cookie banner. Use this to override colours, fonts, or spacing without editing your theme.', 'faz-cookie-manager' ); ?></div>
				</div>
			</div>
		</div>
	</div>
