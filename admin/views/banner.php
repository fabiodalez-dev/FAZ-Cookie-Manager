		...
		<div class="faz-card">
			...
			<div class="faz-card-body">
				...
				<div class="faz-form-group" id="faz-soft-cookie-wall-group">
					<label class="faz-toggle">
						<input type="checkbox" id="faz-b-soft-cookie-wall">
						<span class="faz-toggle-track"></span>
						<span class="faz-toggle-label"><?php esc_html_e( 'Dim the page behind the banner', 'faz-cookie-manager' ); ?></span>
					</label>
			...
			<div class="faz-card-body">
				...
				<div class="faz-form-group">
					<label class="faz-toggle" id="faz-b-accept-toggle">
						<input type="checkbox"<?php disabled( $faz_buttons_locked ); ?><?php echo $faz_buttons_locked ? ' aria-describedby="faz-b-accept-locked"' : ''; ?>>
						<span class="faz-toggle-track"></span>
				...
				<div class="faz-form-group">
					<label class="faz-toggle" id="faz-b-reject-toggle">
						<input type="checkbox"<?php disabled( $faz_buttons_locked ); ?><?php echo $faz_buttons_locked ? ' aria-describedby="faz-b-reject-locked"' : ''; ?>>
						<span class="faz-toggle-track"></span>
			...
			<div class="faz-card-body">
				<div class="faz-form-group">
					<label class="faz-toggle" id="faz-b-revisit-toggle">
						<input type="checkbox"<?php disabled( $faz_revisit_req['all'] ); ?><?php echo $faz_revisit_req['all'] ? ' aria-describedby="faz-b-revisit-locked"' : ''; ?>>
						<span class="faz-toggle-track"></span>
