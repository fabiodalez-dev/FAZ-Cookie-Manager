	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			<table class="faz-status-table">
				...
				<tr><td><?php esc_html_e( 'Auto Scan', 'faz-cookie-manager' ); ?></td><td><?php echo ! empty( $settings['scanner']['auto_scan'] ) ? '&#9989; ' . esc_html__( 'Yes', 'faz-cookie-manager' ) . ' &mdash; ' . esc_html( $settings['scanner']['scan_frequency'] ?? 'weekly' ) : faz_status_flag( false ); ?></td></tr>
				...
				<tr><td><?php esc_html_e( 'Age Gate', 'faz-cookie-manager' ); ?></td><td><?php echo ! empty( $settings['age_gate']['enabled'] ) ? '&#9989; ' . esc_html__( 'Yes', 'faz-cookie-manager' ) . ' (min ' . absint( $settings['age_gate']['min_age'] ?? 16 ) . ')' : faz_status_flag( false ); ?></td></tr>
