	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'When enabled, the cookie consent banner is shown to visitors who have not yet given or denied consent.', 'faz-cookie-manager' ); ?></div>
			</div>
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'Enter page IDs or URL patterns (one per line) where the banner should not appear. Supports wildcards, e.g. /checkout/*', 'faz-cookie-manager' ); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'Records every visitor consent action (accept, reject, customise) in your local database. Required by GDPR Article 7 for demonstrating valid consent.', 'faz-cookie-manager' ); ?></div>
			</div>
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'How long consent records are kept before automatic deletion. Most regulations require at least 12 months.', 'faz-cookie-manager' ); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'Upper limit for the Standard scan depth. The scanner crawls your site pages in the browser to detect cookies. Higher values find more cookies but take longer.', 'faz-cookie-manager' ); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'Enable if you use Microsoft Advertising (Bing Ads). Sends consent signals via the UET tag so Microsoft respects visitor choices.', 'faz-cookie-manager' ); ?></div>
			</div>
			<div class="faz-form-group">
				<label class="faz-toggle">
				...
				<div class="faz-help"><?php esc_html_e( 'Enable if you use Microsoft Clarity for session recordings and heatmaps. Passes consent status so Clarity only records when the visitor has consented.', 'faz-cookie-manager' ); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'The IAB Transparency and Consent Framework is required by most programmatic advertising platforms (Google AdSense, AdX, header bidding). Enable this if you run ads on your site.', 'faz-cookie-manager' ); ?></div>
			</div>
			<div class="faz-form-group" data-show-if="iab.enabled" style="margin-top:12px;">
				...
				<div class="faz-help"><?php esc_html_e( 'ISO 3166-1 alpha-2 code of the country where the publisher (you) is established (e.g. IT, DE, FR, US). This is embedded in the TCF consent string.', 'faz-cookie-manager' ); ?></div>
			</div>
			<div class="faz-form-group" data-show-if="iab.enabled" style="margin-top:12px;">
			...
			<div class="faz-form-group" data-show-if="iab.enabled" style="margin-top:12px;">
				...
				<div class="faz-help"><?php esc_html_e( 'Enable only if your country does not require consent for Purpose 1 (Store and/or access information on a device). Most EU countries require it, so leave this off unless you are certain.', 'faz-cookie-manager' ); ?></div>
			</div>
			<div class="faz-form-group" data-show-if="iab.enabled" style="margin-top:12px;">
				...
				<div class="faz-help"><?php esc_html_e( 'The Global Vendor List (GVL) is maintained by IAB Europe and contains all registered ad-tech vendors. It is updated automatically every week.', 'faz-cookie-manager' ); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="faz-card">
		...
		<div class="faz-card-body">
			...
			<div class="faz-form-group">
				...
				<div class="faz-help"><?php esc_html_e( 'Your GeoLite2 license key from your MaxMind account. The key is stored locally and used only to download the database file.', 'faz-cookie-manager' ); ?></div>
			</div>
