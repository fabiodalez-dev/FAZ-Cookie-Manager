...
<div id="faz-gvl">
	...
	<div class="faz-card">
		<div class="faz-card-header" style="display:flex;align-items:center;justify-content:space-between;">
			<h3><?php echo esc_html__( 'Global Vendor List (IAB TCF 2.3)', 'faz-cookie-manager' ); ?></h3>
			<button class="faz-btn faz-btn-secondary faz-btn-sm" id="faz-gvl-download" type="button"><?php echo esc_html__( 'Update GVL Now', 'faz-cookie-manager' ); ?></button>
		</div>
		<div class="faz-card-body">
			...
			<div class="faz-help"><?php echo esc_html__( 'The Global Vendor List is published by IAB Europe and contains all registered ad-tech vendors with their declared purposes and legal bases. Select the vendors you work with to include them in the TCF consent flow.', 'faz-cookie-manager' ); ?></div>
		</div>
	</div>

	<div class="faz-card">
		<div class="faz-card-header">
			<h3><?php echo esc_html__( 'Vendor Selection', 'faz-cookie-manager' ); ?></h3>
		</div>
		<div class="faz-card-body">
			<div style="display:flex;gap:12px;margin-bottom:16px;align-items:center;">
				...
				<select id="faz-gvl-purpose-filter" class="faz-input" aria-label="<?php echo esc_attr__( 'Filter by purpose', 'faz-cookie-manager' ); ?>" style="width:auto;">
					<option value="0"><?php echo esc_html__( 'All purposes', 'faz-cookie-manager' ); ?></option>
				</select>
			...
			<div style="margin-bottom:8px;">
				<label for="faz-gvl-select-all" style="cursor:pointer;font-weight:600;">
					<input type="checkbox" id="faz-gvl-select-all"> <?php echo esc_html__( 'Select all on this page', 'faz-cookie-manager' ); ?>
				</label>
			</div>
			...
			<div style="margin-top:16px;">
				<button class="faz-btn faz-btn-primary" id="faz-gvl-save" type="button"><?php echo esc_html__( 'Save Selection', 'faz-cookie-manager' ); ?></button>
			</div>
		</div>
	</div>
