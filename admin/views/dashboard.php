...
<div id="faz-dashboard">
	...
	<div class="faz-chart-filter-bar" style="margin-top:20px;">
		<div class="faz-chart-filter-presets">
			<button type="button" class="faz-chart-filter-btn" data-days="1"><?php esc_html_e( '1D', 'faz-cookie-manager' ); ?></button>
			<button type="button" class="faz-chart-filter-btn active" data-days="7"><?php esc_html_e( '7D', 'faz-cookie-manager' ); ?></button>
			<button type="button" class="faz-chart-filter-btn" data-days="30"><?php esc_html_e( '30D', 'faz-cookie-manager' ); ?></button>
			<button type="button" class="faz-chart-filter-btn" data-days="365"><?php esc_html_e( '1Y', 'faz-cookie-manager' ); ?></button>
	...
	<div class="faz-grid faz-grid-2" style="margin-top:12px;">
		<div class="faz-card">
			<div class="faz-card-header">
				<h3><?php esc_html_e( 'Pageviews', 'faz-cookie-manager' ); ?> &mdash; <span id="faz-chart-range-label"><?php esc_html_e( 'Last 7 Days', 'faz-cookie-manager' ); ?></span></h3>
			</div>
			<div class="faz-card-body">
				<div class="faz-chart-wrap">
					...
					<div id="faz-chart-empty" class="faz-chart-empty faz-hidden">
						...
						<p><?php esc_html_e( 'No pageview data yet.', 'faz-cookie-manager' ); ?><br><?php esc_html_e( 'Data will appear once visitors interact with your site.', 'faz-cookie-manager' ); ?></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="faz-card">
			<div class="faz-card-header">
				<h3><?php esc_html_e( 'Consent Distribution', 'faz-cookie-manager' ); ?> &mdash; <span id="faz-consent-range-label"><?php esc_html_e( 'Last 7 Days', 'faz-cookie-manager' ); ?></span></h3>
			</div>
			<div class="faz-card-body">
				<div class="faz-chart-wrap">
					...
					<div id="faz-consent-empty" class="faz-chart-empty faz-hidden">
						...
						<p><?php esc_html_e( 'No consent data yet.', 'faz-cookie-manager' ); ?><br><?php esc_html_e( 'Data will appear once visitors respond to the banner.', 'faz-cookie-manager' ); ?></p>
					</div>
				</div>
			</div>
		</div>
