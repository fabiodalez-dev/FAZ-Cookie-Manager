...
### Added
- Language-aware cookie policy publication at the end of guided setup. The shortcode pins the selected language and jurisdiction; repeated submissions reuse the existing page, missing translations block automatic publication, and custom banner links are preserved.
