...
- Under an opt-out law (CCPA/CPRA) the banner is not re-offered after a signal: there the signal is the consumer's decision, and 11 CCR §7026(k) asks a business to wait twelve months before inviting an opted-out consumer to opt back in. Under an opt-in law it stays available, as described above.
