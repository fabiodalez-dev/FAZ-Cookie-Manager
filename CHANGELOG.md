...
- GPC audit carry-forward preserves an unknown legacy verdict and requires the current consent cookie's grant and exception marker. Consent list and CSV export share the same exception filter.
